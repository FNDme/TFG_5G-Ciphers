...
// Redefine of SnowVi_XMM_ROUND to reduce the number of copies of the state
// using register pivoting instead of temporary variables.
// Now we use A2 and B2 as window registers instead of T1 and T2 as temporary
// variables.
...
int main()
{
  ...
  printf("Speedup: %f %%\n", (((double)time_original / (double)time_improve) - 1) * 100);
